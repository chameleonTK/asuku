...
class AsukuServer():
  ...
  def run(self):
    print 'Start QA Server Daemon...'
    try:
      base_dir = "/home/imtk/asuku/"
      allword_file = open(base_dir+'allword.txt', 'r')
      vector_file = open(base_dir+'question_vector.txt', 'r')
      answer_file = open(base_dir+'answer.txt', 'r')
      image_file = open(base_dir+'answer_image.txt', 'r')
      default_ans_file = open(base_dir+'default_answer.txt', 'r')
      log_file = open(base_dir+'asksimi_log.txt', 'a')
      ...
      while True:
        ...
        try:
          ...
          new_question = self.preprocess(new_question)
